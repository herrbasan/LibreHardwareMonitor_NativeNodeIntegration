...
class LibreMonClient extends EventEmitter {
  /**
   * Create a new client
   * @param {string|null} exePath - Path to LibreMonCLI.exe (defaults to dist/NativeLibre_CLI/LibreMonCLI.exe)
   */
  constructor(exePath = null) {
    super();
    this.exePath = exePath || path.join(__dirname, '..', '..', '..', 'dist', 'NativeLibre_CLI', 'LibreMonCLI.exe');
    this.process = null;
    this.rl = null;
   ...
   * @param {boolean} options.cpu
   * @param {boolean} options.gpu
   * @param {boolean} options.memory
   * @param {boolean} options.motherboard
   * @param {boolean} options.storage
   * @param {boolean} options.network
   * @param {boolean} options.psu
   * @param {boolean} options.controller
   * @param {boolean} options.battery
  ...
  async poll() {
    ...
    return this.sendCommand({ cmd: 'poll' });
  }
